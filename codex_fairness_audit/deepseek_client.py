...
class DeepseekClient(OpenAIClient):
    ...
    def build_request_data(
        ...
        # DeepSeek V4 Flash enables thinking by default. MemGPT deliberately
        # forces a tool on the first step, which DeepSeek rejects in thinking
        # mode ("Thinking mode does not support this tool_choice"). Keep
        # MemGPT's tool policy intact and explicitly disable thinking instead.
