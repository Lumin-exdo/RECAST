# MyMem / NewMem — Claude Code Instructions
...
**Working directory for all commands:** `/home/lumin_exdo` (not inside MyMem)
**Run command:** `python -m MyMem.run_new_mem`
